...
// Hand-written seed bank. These are the reference questions the generator
// few-shots from, and the ones I trust without re-validation. The aggregator
// in questions.ts stamps `source: "seed"` on each entry.
export const seed: Omit<Question, "source">[] = [
  {
    id: 1,
